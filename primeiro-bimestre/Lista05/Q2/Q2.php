...
<?php
    ...
    //Vetor com alguns nomes de produtos de informática e outro com os respectivos preços.
    $infoProd = array("computador", "notebook", "processador", "mouse", "cabo usb");
    $infoPreco = array("30.000,00", "20.000,00", "800,00", "70,00", "25,00");
    ...
    if ($i === false)
        ...
        echo "<br><br>O produto está disponível e armazenado no sistema.";
        echo "<br>Ele se encontra com o código: <b>".$i."</b>,";
        echo " com o preço de: <b>R$".$infoPreco[$i]."</b>.";
    
    // http://localhost/prw/Lista05/Q2/Q2.html
    // http://127.0.0.1/prw/Lista05/Q2/Q2.html
